...
switch ($mod) {
    ...
    case "detail":
        ...
        $id = $model->getProductId($product_alias, 'vi');
        $arrDetailProduct = $model->getDetailProduct($id);
        $data = $arrDetailProduct;        
        $seo =  $arrDetailProduct['data'];

        $detail = $seo  = $data['data'];
    ...
    case "cate":        
        $cate_id = $object_id;            
        $seo = $detail = $model->getDetailCate($cate_id);
        break;
