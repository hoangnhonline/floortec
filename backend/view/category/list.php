                ...
                <table class="table table-bordered table-striped" id="tbl_list">
                    <thead>
                        <tr>
                            ...
                            <th width="30%">Name <img src="img/vi.png" /></th>
                            <th width="30%">Name <img src="img/en.png" width="20" /></th>
                            <th width="20%">Ảnh</th>                        
                    ...
                    <tbody>
                        ...
                        <tr id="row-<?php echo $category['id']; ?>">
                            ...
                            <td style="white-space:nowrap">
                                ...
                                <a title="Click để xóa" href="javascript:;" alias="<?php echo $category['name_vi']; ?>" id="<?php echo $category['id']; ?>" mod="category" class="link_delete" >    
