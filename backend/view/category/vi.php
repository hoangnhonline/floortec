...
<div class="col-md-12">
    <div class="form-group">
        ...
        <textarea name="description_vi" id="description_vi" class="form-control" rows="7"><?php if(!empty($data)) echo $data['description_vi']; ?></textarea>
    </div>
    <div class="form-group">
        <label>Đặc điểm</span></label>
        <textarea name="dacdiem_vi" id="dacdiem_vi" class="form-control" rows="7"><?php if(!empty($data['dacdiem_vi'])) echo $data['dacdiem_vi']; ?></textarea>
    </div>
    <div class="form-group">
        <label>Ứng dụng</span></label>
        <textarea name="ungdung_vi" id="ungdung_vi" class="form-control" rows="7"><?php if(!empty($data['ungdung_vi'])) echo $data['ungdung_vi']; ?></textarea>
    </div>
    <div class="form-group">
        <label>Phân loại</span></label>
        <textarea name="phanloai_vi" id="phanloai_vi" class="form-control" rows="7"><?php if(!empty($data['phanloai_vi'])) echo $data['phanloai_vi']; ?></textarea>
    </div>
</div>